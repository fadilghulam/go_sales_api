...
func Setup(app *fiber.App) {
	...
	app.Post("/cashiers/login/:cashierId", controllers.Login)
	app.Post("/cashiers/logout/:cashierId", controllers.Logout)
	app.Get("/cashiers/passcode/:cashierId", controllers.Passcode)
