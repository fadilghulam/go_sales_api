...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.categoryDo.UseModel(&model.Categories{})
...
type ICategoryDo interface {
	...
	Create(values ...*model.Categories) error
	CreateInBatches(values []*model.Categories, batchSize int) error
	Save(values ...*model.Categories) error
	First() (*model.Categories, error)
	Take() (*model.Categories, error)
	Last() (*model.Categories, error)
	Find() ([]*model.Categories, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Categories, err error)
	FindInBatches(result *[]*model.Categories, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Categories) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Categories, error)
	FirstOrCreate() (*model.Categories, error)
	FindByPage(offset int, limit int) (result []*model.Categories, count int64, err error)
...
func (c categoryDo) Create(values ...*model.Categories) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) CreateInBatches(values []*model.Categories, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categoryDo) Save(values ...*model.Categories) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) First() (*model.Categories, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Categories), nil
	}
}

func (c categoryDo) Take() (*model.Categories, error) {
...
func (c categoryDo) Last() (*model.Categories, error) {
...
func (c categoryDo) Find() ([]*model.Categories, error) {
	result, err := c.DO.Find()
	return result.([]*model.Categories), err
}

func (c categoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Categories, err error) {
	buf := make([]*model.Categories, 0, batchSize)
...
func (c categoryDo) FindInBatches(result *[]*model.Categories, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categoryDo) FirstOrInit() (*model.Categories, error) {
...
func (c categoryDo) FirstOrCreate() (*model.Categories, error) {
...
func (c categoryDo) FindByPage(offset int, limit int) (result []*model.Categories, count int64, err error) {
...
func (c categoryDo) Delete(models ...*model.Categories) (result gen.ResultInfo, err error) {
