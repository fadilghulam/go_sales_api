...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.TotalFinalPrice = field.NewInt64(tableName, "total_final_price")
	_product.TotalNormalPrice = field.NewInt64(tableName, "total_normal_price")
	...
	_product.DiscountID = field.NewInt64(tableName, "discount_id")
...
type product struct {
	...
	Price            field.Int64
	Image            field.String
	TotalFinalPrice  field.Int64
	TotalNormalPrice field.Int64
	CreatedAt        field.Time
	UpdatedAt        field.Time
	CategoryID       field.Int64
	DiscountID       field.Int64
...
func (p *product) updateTableName(table string) *product {
	...
	p.TotalFinalPrice = field.NewInt64(table, "total_final_price")
	p.TotalNormalPrice = field.NewInt64(table, "total_normal_price")
	p.CreatedAt = field.NewTime(table, "created_at")
	p.UpdatedAt = field.NewTime(table, "updated_at")
	p.CategoryID = field.NewInt64(table, "category_id")
	p.DiscountID = field.NewInt64(table, "discount_id")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["total_final_price"] = p.TotalFinalPrice
	p.fieldMap["total_normal_price"] = p.TotalNormalPrice
