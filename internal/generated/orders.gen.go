...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.CashierID = field.NewInt64(tableName, "cashier_id")
	_order.PaymentTypesID = field.NewInt64(tableName, "payment_types_id")
	_order.TotalPrice = field.NewInt64(tableName, "total_price")
	_order.TotalPaid = field.NewInt64(tableName, "total_paid")
	_order.TotalReturn = field.NewInt64(tableName, "total_return")
	_order.ReceiptID = field.NewString(tableName, "receipt_id")
	_order.IsDownload = field.NewInt64(tableName, "is_download")
	_order.ProductID = field.NewString(tableName, "product_id")
	_order.Quantities = field.NewString(tableName, "quantities")
...
type order struct {
	...
	ALL            field.Asterisk
	ID             field.Int64
	CashierID      field.Int64
	PaymentTypesID field.Int64
	TotalPrice     field.Int64
	TotalPaid      field.Int64
	TotalReturn    field.Int64
	ReceiptID      field.String
	IsDownload     field.Int64
	ProductID      field.String
	Quantities     field.String
...
func (o *order) updateTableName(table string) *order {
	...
	o.CashierID = field.NewInt64(table, "cashier_id")
	o.PaymentTypesID = field.NewInt64(table, "payment_types_id")
	o.TotalPrice = field.NewInt64(table, "total_price")
	o.TotalPaid = field.NewInt64(table, "total_paid")
	o.TotalReturn = field.NewInt64(table, "total_return")
	o.ReceiptID = field.NewString(table, "receipt_id")
	o.IsDownload = field.NewInt64(table, "is_download")
	o.ProductID = field.NewString(table, "product_id")
	o.Quantities = field.NewString(table, "quantities")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["id"] = o.ID
	o.fieldMap["cashier_id"] = o.CashierID
	o.fieldMap["payment_types_id"] = o.PaymentTypesID
	o.fieldMap["total_price"] = o.TotalPrice
	o.fieldMap["total_paid"] = o.TotalPaid
	o.fieldMap["total_return"] = o.TotalReturn
	o.fieldMap["receipt_id"] = o.ReceiptID
	o.fieldMap["is_download"] = o.IsDownload
	o.fieldMap["product_id"] = o.ProductID
	o.fieldMap["quantities"] = o.Quantities
