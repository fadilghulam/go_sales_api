...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.ID = field.NewInt16(tableName, "id")
	_customer.SalesmanID = field.NewInt16(tableName, "salesman_id")
	_customer.CustomerName = field.NewString(tableName, "customer_name")
	_customer.OutletName = field.NewString(tableName, "outlet_name")
	_customer.Type = field.NewString(tableName, "type")
	_customer.Address = field.NewString(tableName, "address")
	_customer.SubDistrict = field.NewString(tableName, "sub_district")
	_customer.District = field.NewString(tableName, "district")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.ID = field.NewInt16(table, "id")
	c.SalesmanID = field.NewInt16(table, "salesman_id")
	...
	c.SubDistrict = field.NewString(table, "sub_district")
	c.District = field.NewString(table, "district")
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["sub_district"] = c.SubDistrict
	c.fieldMap["district"] = c.District
