...
func newPayment(db *gorm.DB, opts ...gen.DOOption) payment {
	...
	_payment.Type = field.NewString(tableName, "type")
	_payment.PaymentTypeID = field.NewInt64(tableName, "payment_type_id")
	_payment.Logo = field.NewString(tableName, "logo")
...
func (p *payment) updateTableName(table string) *payment {
	...
	p.PaymentTypeID = field.NewInt64(table, "payment_type_id")
...
func (p *payment) fillFieldMap() {
	...
	p.fieldMap["payment_type_id"] = p.PaymentTypeID
